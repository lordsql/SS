...
$menuItems = @(
    ...
    [PSCustomObject]@{ Name = 'System Informer'; Type = 'Download'; Command = 'https://github.com/winsiderss/si-builds/releases/download/3.2.25316.2456/systeminformer-build-canary-setup.exe'; HasSide = $false }
